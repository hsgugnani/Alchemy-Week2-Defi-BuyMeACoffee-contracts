...
//Deployed to Goerli at:  0xD52bFd47A2cC391edDa568Cad4A8C79EcCdE1afC
...
contract BuyMeACoffee {
     ...
     * @param _name name of the Tea purchaser
     * @param _message a nice message from the purchaser
     */
    function buyTea(string memory _name, string memory _message) public payable {
        // Must accept more than 0 ETH for a tea.
    ...
    /**
    *@dev allow the change for address
     **/
    function TransferWithdrawTips(address payable _newOwner) public {
